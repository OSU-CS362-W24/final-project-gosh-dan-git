...
describe('Scatter.html basic operations', () => {
    ...
    it('Should take you back to the scatter chart of the saved image upon click', () => {
        cy.get('#chart-title-input').type('My Scatter Chart')
        cy.get('#x-label-input').type('x') 
        cy.get('#y-label-input').type('y')
        cy.get('.data-entry input').eq(2).type('1')
    ...
    it('Should allow saving multiple charts', () => {
        ...
        cy.get('#chart-title-input').type('My Scatter Chart 1')
        cy.get('#x-label-input').type('x') 
        cy.get('#y-label-input').type('y')
        cy.get('.data-entry input').eq(2).type('1')
        cy.get('.data-entry input').eq(3).type('2')
    ...
    it('Should take you back to the line chart upon press', () => {
